...
(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        {id:"last_available_confirmed", alias:"Casos Confirmados", dataType: tableau.dataTypeEnum.int},
        {id:"last_available_confirmed_per_100k_inhabitants", alias:"Casos Confirmados/100.000 hab.", dataType: tableau.dataTypeEnum.float},
        {id:"last_available_date", alias:"Data da qual o dado se refere", dataType: tableau.dataTypeEnum.date},
        {id:"last_available_death_rate", alias:"Letalidade", dataType: tableau.dataTypeEnum.float, aggType: tableau.aggTypeEnum.avg, numberFormat: tableau.numberFormatEnum.percentage},
        {id:"last_available_deaths", alias:"Óbitos Confirmados", dataType: tableau.dataTypeEnum.int},
