...
(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        {id:"last_available_death_rate", alias:"Taxa de Óbitos do Último Dia Disponível", dataType: tableau.dataTypeEnum.float, aggType: tableau.aggTypeEnum.avg, numberFormat: tableau.numberFormatEnum.percentage},
        {id:"last_available_deaths", alias:"Óbitos do Último Dia Disponível", dataType: tableau.dataTypeEnum.int},
